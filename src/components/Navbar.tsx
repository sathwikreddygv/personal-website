...
const Navbar = ({}) => {
	return (
		<div id='sticky-parallax-header' className="sticky top-4 left-1/2 -translate-x-1/2  bg-opacity-60 backdrop-blur-[10px] flex items-center w-[40vw] rounded-full px-4 z-20">
